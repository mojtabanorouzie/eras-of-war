...
const STEPS = [
  ...
  },
  {
    ...
    body: 'هر زمین سنگرِ خودش را دارد: تنهٔ درخت، تپهٔ شن، دیوارِ آوار. پشتشان گلوله به تو نمی‌رسد. حواست به خشاب باشد — وسطِ موج، بارگذاری طولانی‌ترین لحظهٔ عمرت است. و هر سومین دشمنی که می‌افتد چیزی جا می‌گذارد: جعبهٔ سبزِ درمان یا جعبهٔ طلاییِ مهمات که خشاب را همان‌جا پر می‌کند. رویش راه برو تا برش داری — و اگر لازمش نداری، همان‌جا می‌ماند.',
  },
  {
      ...
      <div className="shell stack">
        ...
        <section className="card stack stack--tight">
          ...
          <div className="breakdown">
            ...
            <div className="breakdown__row">
              <span>⬆ پرش</span>
              <b className="num">از روی آوارِ کوتاه و تیرها</b>
            </div>
            <div className="breakdown__row">
              <span>⤢ غلت</span>
          ...
          <p className="small">
            ...
            <b>Space</b> برای پرش، <b>C</b> برای غلت و <b>R</b> برای بارگذاری.
          </p>
          <p className="small">
            🎮 دستهٔ بازی هم کار می‌کند و خودش شناخته می‌شود: اهرم چپ حرکت، اهرم راست نشانه‌گیری،
            ماشهٔ راست شلیک، ماشهٔ چپ نشانه‌روی، <b>A</b> پرش، <b>B</b> غلت، <b>X</b> بارگذاری، و فشار
            دادنِ اهرم چپ دویدن. وقتی ضربه بخوری، دسته می‌لرزد.
          </p>
        </section>
